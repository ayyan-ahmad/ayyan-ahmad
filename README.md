...
- 🧪 Writing tests that actually catch bugs, not just cover lines

<br/>

## 🎯 2026 Goals

- [ ] Land a Full Stack Developer / SDE Internship
- [ ] Solve 500+ DSA problems across LeetCode & GeeksforGeeks
- [ ] Launch **JobFit AI** publicly with real users
- [ ] Contribute to 5+ open-source repositories
- [ ] Master System Design fundamentals
- [ ] Build and ship 2 more full-stack SaaS products
...
- [ ] Maintain **JobFit AI** as a public open-source repository
...
- 🧩 A problem-solving foundation built on consistent, deliberate DSA practice
- 🏗️ End-to-end ownership — comfortable across schema design, APIs, and UI
- 🤝 Clear communication — I document as I build, not after
- 🔄 Fast ramp-up on new tools and codebases, minimal hand-holding required
- 🎯 A bias toward shipping working features over polishing demos
